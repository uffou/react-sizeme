...
var ReferenceWrapper = (function(_Component) {
  ...
  function ReferenceWrapper() {
    ...
    return possibleConstructorReturn(
      this,
      (
        ReferenceWrapper.__proto__ || Object.getPrototypeOf(ReferenceWrapper)
...
var renderWrapper = function renderWrapper(WrappedComponent) {
  function SizeMeRenderer(props) {
    var explicitRef = props.explicitRef,
      ...
      onSize = props.onSize,
      restProps = objectWithoutProperties(props, [
        'explicitRef',
        'className',
        'style',
        'size',
    ...
    var toRender = renderPlaceholder
      ...
      : React__default.createElement(
          WrappedComponent,
          _extends({}, renderProps, restProps),
        )
  ...
  SizeMeRenderer.displayName =
    'SizeMeRenderer(' + getDisplayName(WrappedComponent) + ')'
...
function withSize() {
  ...
  var _config$monitorWidth = config.monitorWidth,
    ...
    resizeDetectorStrategy =
      _config$resizeDetecto === undefined
  ...
  return function WrapComponent(WrappedComponent) {
    ...
    var SizeAwareComponent = (function(_React$Component) {
      ...
      function SizeAwareComponent() {
        ...
        return (
          (_ret = ((_temp = ((_this2 = possibleConstructorReturn(
            this,
            (_ref2 =
              SizeAwareComponent.__proto__ ||
              Object.getPrototypeOf(SizeAwareComponent)).call.apply(
              _ref2,
              [this].concat(args),
            ),
          )),
          ...
          (_this2.strategisedGetState = function() {
            return _this2.strategy === 'callback'
              ? _this2.callbackState
              : _this2.state
          }),
    ...
    SizeAwareComponent.displayName =
      'SizeMe(' + getDisplayName(WrappedComponent) + ')'
...
var SizeMe = (function(_Component) {
  ...
  function SizeMe(props) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (SizeMe.__proto__ || Object.getPrototypeOf(SizeMe)).call(this, props),
    )
  ...
  createClass(SizeMe, [
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        var _props = this.props,
          ...
          prevSizeMeConfig = objectWithoutProperties(_props, [
            'children',
            'render',
          ])
        var nextChildren = nextProps.children,
          nextRender = nextProps.render,
          nextSizeMeConfig = objectWithoutProperties(nextProps, [
            'children',
            'render',
          ])
...
var SizeMe$1 = mobxReact.observer(SizeMe)

withSize.SizeMe = SizeMe$1
